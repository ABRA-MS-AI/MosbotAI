...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Process documents from Azure Blob Storage into search index")

    parser.add_argument("--source-account", required=True, help="Source Azure Blob Storage account name")
    parser.add_argument("--source-container", required=True, help="Source Azure Blob Storage container name")
    parser.add_argument("--source-prefix", help="Optional path prefix within the source container")
    parser.add_argument(
        "--source-key", help="Optional storage key for source account (use managed identity if not provided)"
    )
    parser.add_argument("--category", help="Category to assign to all processed documents")
    parser.add_argument("--remove", action="store_true", help="Remove documents instead of adding them")
    parser.add_argument("--remove-all", action="store_true", help="Remove all documents from the index")
